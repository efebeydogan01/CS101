   ...
   public static void main( String[] args)
   {
      ...
      do
      {
         ...
         else if ( cmd.equals( "Add"))
         {
            ...
            //Print message saying the book was added
            System.out.println( "A book with the title " + title + " and author " + author + " has been added to the library.");
         }
